...
label_posty_lokalizacja_szczegoly_obiektu_wartosc=Label(ramka_szczegoly_obiektu, text="....")
label_posty_lokalizacja_szczegoly_obiektu_wartosc.grid(row=1, column=5)
